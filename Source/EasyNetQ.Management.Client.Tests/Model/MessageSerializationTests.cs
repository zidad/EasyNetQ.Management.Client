...
namespace EasyNetQ.Management.Client.Tests.Model
{
    ...
    public class MessageSerializationTests
    {
        ...
        [Test]
        public void Should_be_able_to_serialize_message_with_properties()
        {
            const string json = @"{""payload_bytes"":11,""redelivered"":true,""exchange"":""""," +
                @"""routing_key"":""management_api_test_queue"",""message_count"":1," +
                @"""properties"":{""delivery_mode"":2,""headers"":{""key"":""value""}},""payload"":""Hello World""," +
            ...
            var message1 = new Message {
                ...
                Redelivered = true,
                Exchange = "",
                RoutingKey = "management_api_test_queue",
                MessageCount = 1,
                PayloadEncoding = "string"
            };

            var message = JsonConvert.SerializeObject(message1, new PropertyConverter());

            message.ShouldEqual(json);
        }
